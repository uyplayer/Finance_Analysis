...
print(stockprices.index.to_numpy())


real = MAVP(stockprices['close'],stockprices.index.to_numpy(), minperiod=2, maxperiod=30, matype=0)
...
ax = df[['close','mama']].plot(figsize=(10, 4))
plt.title(stock + ' MESA Adaptive Moving Average')
plt.axis('tight')
plt.ylabel('Price')
